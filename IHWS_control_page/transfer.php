...
<html lang="en">
  ...
  text-align: center;
  margin-top : 10px;">
  <img src="css/img_ihws/transfer.png"/>


  <form enctype="multipart/form-data" action="transfer_1.php" method="POST">
    <h3>
      File Transfer
    </h3>
     <input type="hidden" name="MAX_FILE_SIZE" value="30000000000" />
     <input  name="userfile" type="file" value = "file" />
     <button style="margin-top:3px" type="submit" class="btn btn-sm btn-primary">Submit</button>
